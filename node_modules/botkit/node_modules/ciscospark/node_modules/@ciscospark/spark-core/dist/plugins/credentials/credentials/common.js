...
exports.default = (_dec = (0, _storage.waitForValue)('authorization'), _dec2 = (0, _storage.waitForValue)('clientAuthorization'), (_obj = {
  ...
  refresh: function refresh(options) {
    ...
    if (!options.force && !(0, _get3.default)(this, 'authorization.isExpired')) {
  ...
  buildLogoutUrl: function buildLogoutUrl(options) {
    // eslint doesn't yet handle nested strings quite right
    /* eslint quotes: [0] */
    return this.config.logoutUri + '?' + _querystring2.default.stringify((0, _assign2.default)({
  ...
  buildOAuthUrl: function buildOAuthUrl(options) {
    ...
    var parameters = (0, _clone3.default)(options);

    parameters.state = parameters.state || {};
    if (!(0, _isObject3.default)(parameters.state)) {
    ...
    fields.forEach(function (key) {
      if (key in _this7.config.oauth) {
        if (key === 'service') {
          parameters.cisService = _this7.config.oauth[key];
        } else {
  ...
  _getSamlBearerToken: function _getSamlBearerToken() {
    ...
    return this.request({
      ...
      body: (0, _pick3.default)(this, 'name', 'password'),
      shouldRefreshAccessToken: false
