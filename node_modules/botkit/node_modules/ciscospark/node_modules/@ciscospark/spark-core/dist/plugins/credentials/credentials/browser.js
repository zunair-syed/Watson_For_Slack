...
var Credentials = _sparkPlugin2.default.extend((0, _assign3.default)({}, _common3.default, (_dec = (0, _storage.waitForValue)('authorization'), _dec2 = (0, _storage.persist)('authorization'), _dec3 = (0, _storage.persist)('clientAuthorization'), (_obj = {
  authorize: function authorize(options) {
    ...
    this.set((0, _pick3.default)(options, 'name', 'orgId', 'password'));
  ...
  initiateImplicitGrant: function initiateImplicitGrant(options) {
    ...
    for (var key in vars) {
      if (!(0, _has3.default)(this.config, key)) {
    ...
    /* eslint camelcase: [0] */
    this._redirect(this.buildOAuthUrl((0, _assign5.default)({ response_type: 'token' }, options)));
  ...
  initiateAuthorizationCodeGrant: function initiateAuthorizationCodeGrant(options) {
    ...
    this._redirect(this.buildOAuthUrl((0, _assign5.default)({ response_type: 'code' }, options)));
    return new _promise2.default(noop);
  },
  initialize: function initialize() {
    ...
    process.nextTick(function () {
      ...
      var query = (0, _clone3.default)(location.query);
  ...
  logout: function logout(options) {
    ...
    if (this.authorization) {
      var token = this.authorization.refresh_token || this.authorization.access_token;
      options = (0, _assign3.default)({ token: token }, options);
    }
    return (0, _apply2.default)(_common3.default.logout, this, [options]).then(function () {
      if (!options.noRedirect) {
        _this2._redirect(_this2.buildLogoutUrl(options));
      }
    });
  },
  ...
  _extractTokenInfo: function _extractTokenInfo(query) {
    ...
    var token = (0, _pick3.default)(query, tokenKeys);
    ...
    query = (0, _omit3.default)(query, tokenKeys);
    query.state = (0, _omit3.default)(query.state, 'csrf_token');
