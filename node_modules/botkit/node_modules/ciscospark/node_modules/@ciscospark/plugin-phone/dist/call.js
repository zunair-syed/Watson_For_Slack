...
function ensureH264(offer) {
  var sdp = _sdpTransform2.default.parse(offer);
  var video = (0, _find3.default)(sdp.media, { type: 'video' });
  if (!video) {
    throw new Error('Expected video section in offer but no such section found');
  }

  var doesHaveH264 = video.rtp.reduce(function (hasH264, rtp) {
    return hasH264 || rtp.codec.includes('264');
  }, false);
  if (!doesHaveH264) {
...
var Call = _sparkCore.SparkPlugin.extend((_obj = {
  ...
  _changeMedia: function _changeMedia(constraints) {
    ...
    return new _promise2.default(function (resolve) {
      ...
      constraints = (0, _defaults3.default)({}, constraints, {
  ...
  _join: function _join(locusMethodName, target, options) {
    ...
    options = options || {};
    options.constraints = (0, _defaults3.default)(options.constraints, {
      audio: true,
      video: true
    });
    ...
    var wantsVideo = options.constraints.video || options.offerOptions.offerToReceiveVideo;
