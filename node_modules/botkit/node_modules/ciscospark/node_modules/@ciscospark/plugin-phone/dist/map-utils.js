...
var addToSet = exports.addToSet = (0, _curry3.default)(function (set, value) {
  set.add(value);
});

var getMapFromMap = exports.getMapFromMap = (0, _curry3.default)(function (map, key) {
...
var getSetFromMap = exports.getSetFromMap = (0, _curry3.default)(function (map, key) {
  var set = map.get(key);
  if (!set) {
...
var getWeakMapFromMap = exports.getWeakMapFromMap = (0, _curry3.default)(function (map, key) {
  var childMap = map.get(key);
  if (!childMap) {
...
var getMappedWeakMappedSet = exports.getMappedWeakMappedSet = (0, _curry3.default)(function (m, mk, wk) {
  var map = getWeakMapFromMap(m, mk);
  var set = getSetFromMap(map, wk);
  return set;
});

var addToMappedWeakMappedSet = exports.addToMappedWeakMappedSet = (0, _curry3.default)(function (m, mk, wk, v) {
  var map = getWeakMapFromMap(m, mk);
  var set = getSetFromMap(map, wk);
  addToSet(set, v);
});
