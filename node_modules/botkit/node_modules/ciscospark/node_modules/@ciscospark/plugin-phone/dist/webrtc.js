  ...
  pc.getLocalStreams().forEach(function (stream) {
    stream.getTracks().forEach(function (track) {
      if (track.kind === kind) {
        ...
        if (pc.removeTrack) {
          var sender = (0, _find3.default)(pc.getSenders(), function (s) {
...
var startReceivingMedia = (0, _curry3.default)(function (kind, pc) {
  var foundKind = false;
...
var stopReceivingMedia = (0, _curry3.default)(function (kind, pc) {
  pc.getRemoteStreams().forEach(function (stream) {
    stream.getTracks().forEach(function (track) {
      if (track.kind === kind) {
        track.enabled = false;
        ...
        storeMediaTrackByKindByStream(kind, stream, track);
        if (pc.removeTrack) {
          var receiver = (0, _find3.default)(pc.getSenders(), function (r) {
